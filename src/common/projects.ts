...
export const projects: Array<IProjects> = [
  {
    id: 1,
    header: "Completing the Church Building",
    description:
  ...
  {
    id: 2,
    header: "Financial Assistance Towards the Completion of Church Building",
    description:
      "Caritas offered financial assistance towards completion of Church building.",
  ...
  {
    id: 3,
    header: "Erecting the Church Foundation",
    description:
  ...
  {
    id: 5,
    header: "Financial Support Towards Erecting a Perimeter",
    description:
  ...
  {
    id: 9,
    header: "Church Building Project",
    description:
  ...
  {
    id: 13,
    header: "Financial assistance to St. Louis Parish, Mbiokporo",
    description:
...
export const corporateCharity: Array<IProjects> = [
  {
    id: 1,
    header: "Financial assistance for the Ordination of Rev. Jude Isuk",
    description:
